...
function cmpfit_function(cube_fitter::CubeFitter, pfix_tied::Vector{<:Real}, plock_tied::BitVector,
    ...
    channel_masks::Vector{BitVector}, stellar_templates::Union{Vector{Interpolations.Extrapolation},Matrix{<:Real},Nothing}, 
    nuc_temp_fit::Bool)
...
function cmpfit_function(cube_fitter::CubeFitter, λ::Vector{<:Real}, pfix_cont_tied::Vector{<:Real}, lock_cont_tied::BitVector,
    ...
    stellar_templates::Union{Vector{Interpolations.Extrapolation},Matrix{<:Real},Nothing}, lsf_interp_func::Base.Callable,
    nuc_temp_fit::Bool)
